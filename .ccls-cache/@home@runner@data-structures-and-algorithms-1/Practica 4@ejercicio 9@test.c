...
int main() {
  ...
  bstree_eliminar(arbol, "arbol", comparar_cadena, destruir_cadena, copiar_cadena);
  bstree_eliminar(arbol, "parque", comparar_cadena, destruir_cadena, copiar_cadena);
  bstree_eliminar(arbol, "edya", comparar_cadena, destruir_cadena, copiar_cadena);
