...
// Consigna: Utilizando la funcion btree_foreach, escriba una funcion que imprima los elementos de un
// arbol y calcule el minimo elemento del mismo en una sola pasada. Si no fuera posible, justifique
// y provea el codigo para hacerlo en dos pasadas.

// Hacerlo en una sola pasada, con una funcion extra que almacene el minimo encontrado. Devolverlo al final
