...
// gcc -Wall avl.c test.c -g -o main
// ./main
...
int main() {
  ...
  // caso de prueba 1:
  // se inreturn heap;sertan 500 enteros aleatorios entre 0 y 999,
  ...
  arbol2->raiz = avl_eliminar(arbol2->raiz, &numeros[1], copiar_puntero_entero,
                              comparar_puntero_entero);
  avl_recorrer(arbol2, AVL_RECORRIDO_PRE, imprimir_puntero_entero, NULL);
  puts("");
  avl_insertar(arbol2, &numeros[1]);
