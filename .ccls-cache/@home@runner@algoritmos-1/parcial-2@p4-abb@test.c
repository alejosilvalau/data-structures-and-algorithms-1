...
// gcc -Wall bstree.c test.c -g -o main
// ./main
...
int main() {
  ...
  // arbol = bstree_eliminar(arbol, "casa", comparar_cadena, destruir_cadena);
  // printf("Recorrido inorden: ");
  // bstree_recorrer(arbol, BTREE_RECORRIDO_IN, imprimir_cadena, NULL);
  // puts("");

  arbol = bstree_eliminar_v2(arbol, "gato", comparar_cadena, destruir_cadena);
  printf("Recorrido inorden: ");
  bstree_recorrer(arbol, BTREE_RECORRIDO_IN, imprimir_cadena, NULL);
  puts("");
