...
/**
 * Recorre el arbol encontrando los nodos a la profundidad indicada,
 * imprimiendolos en el proceso
 */
void btree_recorrer_pre_it_depth(BTree arbol, FuncionVisitanteInt visit,
                                 int depth);

/**
 * Recorre el arbol encontrando los nodos a la profundidad indicada de manera
 * recursiva, imprimiendolos en el proceso
 */
